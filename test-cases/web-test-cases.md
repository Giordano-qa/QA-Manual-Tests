...
## CT-01: Validação de busca de produto - Site: Mercado Livre

**Pré-condição:**

- Usuário deve estar na página inicial do site
...
## CT-02: Abertura do menu lateral - Site: Amazon
...
## CT-03: Validação de email inválido no cadastro - Site: Linkedin
...
## CT-04: Validação de campos obrigatórios vazios - Site: Linkedin
...
## CT-05: Validação de senha com baixo nível de segurança - Site: Linkedin
...
## CT-06: Login com senha inválida - Site: Magazine Luiza
...
- Tela exibindo erro ao inserir senha inválida:
![Senha inválida](../evidencias/CT-06-senha-invalida.png)

---

## CT-07: Login com e-mail inválido - Site: Magazine Luiza
...
## CT-08: Validação de campo senha obrigatório - Site: Magazine Luiza
...
## CT-09: Validação de campo e-mail obrigatório - Site: Magazine Luiza
...
## CT-10: Validação da Funcionalidade mostrar/ocultar senha - Site: Magazine Luiza
...
## CT-11: Validação de tamanho mínimo de senha - Site: Magazine Luiza
